<nav class="bg-white/90 backdrop-blur-md fixed w-full z-50 border-b border-amber-100 shadow-sm" x-data="{ mobileMenuOpen: false }">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div x-show="mobileMenuOpen" @click.away="mobileMenuOpen = false" x-cloak x-transition class="md:hidden mt-4 pb-4 space-y-3 border-t border-amber-100">
            ...
            <a href="{{ route('catalogue.index') }}" @click="mobileMenuOpen = false" class="block text-amber-600 font-semibold py-2">Nos Bougies</a>
